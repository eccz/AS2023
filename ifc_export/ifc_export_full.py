...
from config import TASK_TYPE_ATTR_NAME, TYPE_ATTR_NAME, ASSEMBLY_TYPE_ATTR_NAME
...
def ifc_export_xml_build(property_set, src, ms_mapping=True, class2025=True):
    ...
    - src: источник данных (спарсенный Excel)
...
if __name__ == '__main__':
    ...
    ifc_export_xml_output(res, 'work/results/ifc_profile_NEW.xml')
